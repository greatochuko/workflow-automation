    ...
    <div className="flex-1 text-sm sm:text-base">
      ...
      <main className="mx-auto flex w-[90%] max-w-6xl flex-col gap-4 py-6">
        ...
        <ul className="flex list-inside list-disc flex-col gap-4 pl-6">
          ...
          <li>
            <strong>Application</strong> refers to Clinic Lead Stack, the
        ...
        <h4 className="font-bold sm:text-lg">Personal Data</h4>
        <p>
        ...
        <h4 className="font-bold sm:text-lg">Usage Data</h4>
        ...
        <h4 className="font-bold sm:text-lg">Business Transactions</h4>
        <p>
        ...
        <h4 className="font-bold sm:text-lg">Law enforcement</h4>
        <p>
          Under certain circumstances, the Company may be required to disclose
          Your Personal Data if required to do so by law or in response to valid
          requests by public authorities (e.g. a court or a government agency).
        </p>
        <h4 className="font-bold sm:text-lg">Other legal requirements</h4>
        <p>
