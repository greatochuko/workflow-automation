...
export default function page() {
  return (
    <div className="flex-1 text-sm sm:text-base">
      ...
      <main className="mx-auto flex w-[90%] max-w-6xl flex-col gap-4 py-6">
        ...
        <h3 className="text-lg font-bold sm:text-xl">Interpretation</h3>
        <p>
        ...
        <h3 className="text-lg font-bold sm:text-xl">Definitions</h3>
        ...
        <ul className="flex list-inside list-disc flex-col gap-4 pl-6">
          <li>
            ...
            the Company downloaded by You on any electronic device, named Clinic
            Lead Stack
          </li>
          <li>
          ...
          <li>
            ...
            this Agreement) refers to Clinic Lead Stack.
          </li>
          <li>
        ...
        <h2 className="text-xl font-bold sm:text-2xl">Acknowledgment</h2>
        <p>
        ...
        <h2 className="text-xl font-bold sm:text-2xl">Termination</h2>
        <p>
        ...
        <h2 className="text-xl font-bold sm:text-2xl">Disputes Resolution</h2>
        <p>
        ...
        <h3 className="text-lg font-bold sm:text-xl">Severability</h3>
        <p>
        ...
        <h3 className="text-lg font-bold sm:text-xl">Waiver</h3>
        <p>
        ...
        <ul className="flex list-inside list-disc flex-col gap-4 pl-6">
          <li>
            ...
            <Link
              ...
              href="mailto:clinicleadstack@gmail.com"
            >
              clinicleadstack@gmail.com
            </Link>
          </li>
        </ul>
      </main>
      ...
      <footer className="border-t border-gray-200 py-6">
        <div className="mx-auto w-[90%] max-w-6xl">
          <p className="text-center text-gray-500">
            Copyright {new Date().getFullYear()} Clinic Lead Stack
          </p>
        </div>
      </footer>
    </div>
